...
class ManageImage(Resource):
    ...
    def post(self):
        ...
        if args["os"].lower() not in ["centos7", "rhel7", "amazonlinux2", "windows", "ubuntu18"]:
            return errors.all_errors('CLIENT_MISSING_PARAMETER', "os must be centos7, rhel7, amazonlinux2, ubuntu18 or windows")
